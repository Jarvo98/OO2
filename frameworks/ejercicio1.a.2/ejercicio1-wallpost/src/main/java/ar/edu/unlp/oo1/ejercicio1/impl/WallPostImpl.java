...
public class WallPostImpl implements WallPost {
	...
	public WallPostImpl() {
		...
		this.logger = Logger.getLogger("main.model");
	}
	...
	public void like() {
		...
		if (this.likes == 10) {
			this.logger.warning("El post: " + this.getText() + " ha llegado a 10 likes.");
		}
	}
	...
	public void dislike() {
		if (likes > 0) {
			this.likes = this.likes - 1;
			if (this.likes == 0) {
				this.logger.warning("El post: " + this.getText() + " ha llegado a 0 likes.");
			}
		}
	}
